...
This app relies on the [makeline-service](../makeline-service) and the DocumentDB instance running. A docker-compose file is provided to make this easy. The docker-compose file will also start the RabbitMQ, DocumentDB, [order-service](../order-service), and [virtual-customer](../virtual-customer) services to simulate incoming orders. 
